...
**Space-Travelers-Hub** is a website that provides space travel services. The application will allow users to book rockets and join a space missions.
...
- **List of missions with ability to join or leave**
- **List of rockets with ability to reserve a rocket** 
...
```sh
  cd my-folder
  git clone https://github.com/migo1/space-traveler.git
```
...
Feel free to check the [issues page](https://github.com/migo1/space-traveler/issues).
